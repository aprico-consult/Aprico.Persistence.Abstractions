...
public abstract class UnitOfWorkBase : IUnitOfWork
{
	...
	/// true, both managed and unmanaged resources are disposed; otherwise, only unmanaged resources are released.
	/// </param>
	...
	/// </summary>
	/// <param name="cancellationToken">A token that can be used to signal the operation should be cancelled.</param>
	/// <returns>A task that represents the asynchronous operation.</returns>
	[SuppressMessage("ReSharper", "UnusedParameter.Global", Justification = "Async pattern cancellation token.")]
	protected abstract Task CommitAsyncCore(CancellationToken cancellationToken = default);
